...
连续对话规则：认真使用本轮附带的压缩记忆和最近对话，保持人物、目标、术语、数字、格式、语气与已确认要求一致。压缩记忆与用户最新指令冲突时，以最新指令为准。不要声称记得实际未提供的信息，也不要编造上下文。
...
function auroraCompactMemory(e, t) {
  let n = String(e || ``)
      ...
      .filter(Boolean),
    r = /要求|必须|不要|不能|希望|偏好|论文|题目|字数|格式|客户|身份|目标|研究|对象|方法|数据|引用|章节|时间|风格|名称|修改|保留|删除|重点|结论/;
  for (let e of t) {
    ...
    let t = String(e.content || ``)
      ...
      .split(/(?<=[。！？；\n])/)
      .map((e) => e.trim())
      .filter((e) => e.length >= 4 && e.length <= 260);
    let i = t.filter((e) => r.test(e));
    n.push(...(i.length ? i : t.slice(0, 1)));
  }
  let i = [],
    a = new Set();
  for (let e of n) {
  ...
  if (c && r.length > 6) {
    let t = r.slice(0, -6),
      n = t
        ...
        .slice(-8)
        .map((e) => {
          let t = String(e.content || ``).replace(/\s+/g, ` `).trim();
          return t ? `已完成内容：${t.slice(0, 180)}` : ``;
        })
        .filter(Boolean)
        .join(`\n`);
    (a = `${auroraCompactMemory(a, t)}${n ? `\n${n}` : ``}`.slice(-4800)),
      (i = r.length - 6),
      (o = r.slice(i));
  }
  return {
...
function te() {
  ...
  (0, f.useEffect)(() => {
    Promise.all([v(`providers`), v(`threads`), v(`activeId`), v(`vault`)])
      .then(([e, n, i, o]) => {
            ...
            JSON.stringify({
              ...
              threads: i.map((e) => ({
                ...
                memory: auroraCompactMemory(
                  e.memory || ``,
                  (e.messages || []).slice(0, -6)
                ),
                memoryCheckpoint: Math.max(0, (e.messages || []).length - 6),
  ...
  function auroraAdvancedOpenAI(e) {
    try {
      let t = new URL(e.baseUrl).hostname.toLowerCase();
      return t === `tokenclub.info` || t === `api.openai.com`;
    } catch {
      return !1;
    }
  }
  ...
  async function De(e, t, n, r = ``, i = `chat`) {
    ...
    a =
      e.apiType === `anthropic`
        ...
        : await fetch(x(e.baseUrl, `chat/completions`), {
            method: `POST`,
            headers: {
              "content-type": `application/json`,
  ...
  async function Oe() {
    ...
    try {
      if (c === `image`) {
        ...
        let
          n = k.plainText === !1 ? e.text : auroraPlainOutput(e.text);
        Ee(t.id, {
          id: m(),
          role: `assistant`,
              ...
              : (0, p.jsxs)(`div`, {
                  ...
                  children: [
                    (0, p.jsx)(`div`, {
                      ...
                      children: (0, p.jsx)(`span`, { children: `A` }),
                    }),
                    (0, p.jsx)(`div`, {
                      className: `eyebrow`,
                      children: `YOUR PRIVATE AI WORKSPACE`,
                    }),
                    (0, p.jsx)(`h1`, { children: `今天想一起完成什么？` }),
                    (0, p.jsxs)(`p`, {
                      children: [
                        `在 GPT、Claude、Gemini 与更多模型之间自由切换。`,
                        (0, p.jsx)(`br`, {}),
                        `密钥、对话与作品，只留在你的设备。`,
                      ],
                    }),
